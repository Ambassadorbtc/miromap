...
const companyLinks = [
  ...
  { name: "Twitter / X", href: "https://x.com/Miromapx" },
];
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-14">
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
                ...
                <li><Link href="/cookies" className="text-sm text-ex-gray hover:text-ex-green transition-colors">Cookie Policy</Link></li>
              </ul>
          </div>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-ex-border pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com/Miromapx" target="_blank" rel="noopener noreferrer" className="text-ex-gray hover:text-ex-dark transition-colors" aria-label="Twitter">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="/contact" className="text-ex-gray hover:text-ex-dark transition-colors" aria-label="Discord">
