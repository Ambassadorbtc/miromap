...
export const metadata: Metadata = {
  title: "Export Grok Conversations as PDF, Markdown & More",
  description: "Export xAI Grok conversations as PDF, Markdown, TXT, JSON, or CSV. One click, done.",
  keywords: ["export Grok conversations", "save Grok as PDF", "Grok to markdown", "xAI Grok export"],
  alternates: { canonical: "https://miromap.com/export-grok" },
};
  ...
  return (
    <div className="pt-16">
        ...
        <div className="mx-auto max-w-[800px] px-6">
          <AnimateOnScroll>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-ex-border bg-white px-4 py-1.5 text-sm shadow-sm">
              <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "#1D1D1F" }} />
              <span className="font-medium text-ex-gray">Grok Exporter</span>
            </div>
            <h1 className="text-4xl font-bold text-ex-dark md:text-5xl">Export <span className="text-ex-green">Grok</span> Conversations</h1>
            <p className="mt-4 text-lg text-ex-gray leading-relaxed">Export xAI Grok conversations as PDF, Markdown, TXT, JSON, or CSV. One click, done.</p>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-[800px] px-6">
          <h2 className="text-2xl font-bold text-ex-dark">Why export Grok conversations?</h2>
          <p className="mt-4 text-ex-gray leading-relaxed">Grok by xAI is integrated into X (Twitter) but offers no way to export conversations. Miromap lets you capture and export your Grok chats before they disappear.</p>
          <h2 className="mt-12 text-2xl font-bold text-ex-dark">How to export from Grok</h2>
          <ol className="mt-6 space-y-4">
              ...
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">2</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Open Grok on x.com or grok.x.ai</span></li>
              ...
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">4</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Select the Grok conversations to save</span></li>
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">5</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Choose format and export</span></li>
          </ol>
      ...
      <section className="border-y border-ex-border bg-ex-bg py-14">
        <div className="mx-auto max-w-[700px] px-6">
          ...
          <div className="space-y-6">
              <div><h3 className="text-base font-semibold text-ex-dark">Can I export from X/Twitter?</h3><p className="mt-1.5 text-sm text-ex-gray leading-relaxed">Yes. Miromap detects Grok on both x.com and grok.x.ai.</p></div>
              <div><h3 className="text-base font-semibold text-ex-dark">Does Grok have built-in export?</h3><p className="mt-1.5 text-sm text-ex-gray leading-relaxed">No. Miromap is currently the only solution.</p></div>
