...
export const metadata: Metadata = {
  title: "Export Claude Conversations as PDF, Markdown & More",
  description: "Export your Claude conversations as PDF, Markdown, TXT, JSON, or CSV. No more copy-pasting.",
  keywords: ["export Claude conversations", "save Claude as PDF", "Claude to markdown", "download Claude chat"],
  alternates: { canonical: "https://miromap.com/export-claude" },
};
  ...
  return (
    <div className="pt-16">
        ...
        <div className="mx-auto max-w-[800px] px-6">
          <AnimateOnScroll>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-ex-border bg-white px-4 py-1.5 text-sm shadow-sm">
              <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "#D97757" }} />
              <span className="font-medium text-ex-gray">Claude Exporter</span>
            </div>
            <h1 className="text-4xl font-bold text-ex-dark md:text-5xl">Export <span className="text-ex-green">Claude</span> Conversations</h1>
            <p className="mt-4 text-lg text-ex-gray leading-relaxed">Export your Claude conversations as PDF, Markdown, TXT, JSON, or CSV. No more copy-pasting.</p>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-[800px] px-6">
          <h2 className="text-2xl font-bold text-ex-dark">Why export Claude conversations?</h2>
          <p className="mt-4 text-ex-gray leading-relaxed">Anthropic Claude does not offer a built-in conversation export feature. Miromap solves this by reading your Claude conversations directly and letting you export them in any format.</p>
          <h2 className="mt-12 text-2xl font-bold text-ex-dark">How to export from Claude</h2>
          <ol className="mt-6 space-y-4">
              ...
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">2</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Open claude.ai and navigate to any conversation</span></li>
              ...
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">4</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Select the Claude conversations you want to save</span></li>
              <li className="flex gap-4"><span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-sm font-bold text-ex-green">5</span><span className="text-sm text-ex-dark leading-relaxed pt-1">Pick your format and export instantly</span></li>
          </ol>
      ...
      <section className="border-y border-ex-border bg-ex-bg py-14">
        <div className="mx-auto max-w-[700px] px-6">
          ...
          <div className="space-y-6">
              <div><h3 className="text-base font-semibold text-ex-dark">Does Claude have a built-in export?</h3><p className="mt-1.5 text-sm text-ex-gray leading-relaxed">Not currently. Miromap is the easiest way to export full Claude conversations.</p></div>
              <div><h3 className="text-base font-semibold text-ex-dark">Works with Claude Pro and Teams?</h3><p className="mt-1.5 text-sm text-ex-gray leading-relaxed">Yes. Works with all Claude plans.</p></div>
              <div><h3 className="text-base font-semibold text-ex-dark">Is my data private?</h3><p className="mt-1.5 text-sm text-ex-gray leading-relaxed">Yes. Everything is processed locally. No data sent to external servers.</p></div>
          </div>
        </div>
      </section>
